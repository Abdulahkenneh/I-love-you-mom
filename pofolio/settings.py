...
SECRET_KEY = 'django-insecure-+x6&!@p_1r##1y6xe63mhtaot+q1cw(9gu#uz(0be4+jwb##ii'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['code-with-python.herokuapp.com']
...
# htt ps://docs.djangoproject.com/en/5.0/ref/settings/#default-auto-field
